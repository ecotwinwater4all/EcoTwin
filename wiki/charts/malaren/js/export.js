...
function exportSVG() {
  ...
  _download(URL.createObjectURL(blob), 'lake-malaren-dataflow.svg');
}
...
function exportPNG() {
  ...
  img.onload = function() {
    ...
    _download(c.toDataURL('image/png'), 'lake-malaren-dataflow.png');
  };
  img.src = url;
}
...
var DEFAULT_PANEL_HTML =
  ...
  '<p>Lake Mälaren digital twin: an end-to-end architecture linking meteorological and hydrological data through numerical models, validation, and forecast delivery to stakeholders.</p>' +
  '<h4>Status</h4>' +
  '<ul>' +
